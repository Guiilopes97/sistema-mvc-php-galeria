...
<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 gap-4">
    <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Enviar Nova Foto</h1>
</div>
...
<div class="bg-white shadow-sm rounded-lg p-4 sm:p-6">
    <form method="POST" action="/photos" enctype="multipart/form-data" class="space-y-4 sm:space-y-6" id="uploadForm">
        <!-- Upload de Imagem -->
        <div>
            ...
            <div id="imagePreview" class="mt-4 hidden">
                ...
                <p class="text-xs sm:text-sm text-gray-500 mt-2">Preview da imagem (será redimensionada para 1920x1080)</p>
            </div>
        </div>
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4" 
                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
                      placeholder="Descreva a foto (opcional)"><?= htmlspecialchars($data['description'] ?? '') ?></textarea>
        </div>

        <!-- Informações sobre redimensionamento -->
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-1 sm:mt-2 text-xs sm:text-sm text-blue-700">
                        <ul class="list-disc list-inside space-y-1">
                            <li>A imagem será automaticamente redimensionada para 1920x1080 pixels</li>
                            <li>A proporção original será mantida (sem distorção)</li>
                            <li>A qualidade será otimizada para web</li>
                            <li>Formatos suportados: JPEG, PNG, GIF, WebP</li>
                        </ul>
                    </div>
                </div>
            </div>
